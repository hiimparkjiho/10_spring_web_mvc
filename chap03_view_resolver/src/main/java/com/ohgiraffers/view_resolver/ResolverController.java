package com.ohgiraffers.view_resolver;
...
public class ResolverController {
    ...
    public String stringReturing(Model model){
        ...
        * thymeleafViewResolver에게 Resource/template/를 prefix로, .html을 suffix로 설정하여
    ...
    // 기본적으로 redirect시에는 재요청이 발생하므로 request scope는 소멸한다
    // 하지만 스프링에서는 RedirectAttribute 타입을 통해 redirect시 속성 값을 저장할 수 있도록 하는 기능을 제공하다.
    ...
    public String stringRedirectFlashAttribute(RedirectAttributes rttr){
        ...
        * 세션에 임시로 값을 담고 소멸하는 방식이기 때문에 session에 동일한 키값이 존재하지 않아햐 한다.
        * */
