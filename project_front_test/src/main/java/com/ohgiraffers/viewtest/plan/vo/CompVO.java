package com.ohgiraffers.viewtest.plan.vo;
...
public class CompVO {
    ...
    public CompVO(int compCode, String compName, String compLat, String compHar, String compCategory, Date registDate, Date updateDate) {
